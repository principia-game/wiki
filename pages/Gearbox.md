...
The gearbox has two input signal sockets. **`IN0`** shifts the gear -1 step and **`IN1`** shifts the gear +1 step. The gear is shifted by moving the input axle to the next valid configuration. Use a sparsifier to prevent the gear from being switched too quickly.

## Socket information
- **`IN0`**: Shift gear -1 step
- **`IN1`**: Shift gear +1 step
