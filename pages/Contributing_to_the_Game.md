...
## LLM usage policy
Submitting pull requests to the project that are "vibe-coded" or otherwise solely generated by LLMs/AI is not allowed, whether it be by autonomous AI agents or humans. You should, as a general rule, understand the code changes you are contributing.
