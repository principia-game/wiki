![](/wiki/images/imgur/tO4WXCl.webp)

For a beginner boss tutorial, see this tutorial: [[Creating a Simple Adventure Boss]]
...
![](/wiki/images/imgur/lXQk4Qg.webp)
...
Use "Connection Edit" and click a connection you want to make destructible and decrease the strength slider just a bit (0.95). Add an FX emitter somewhere near it and set its config to "Destroy Connections", and "Explosion" if you want explosions when its being destroyed.
...
![](/wiki/images/imgur/i8o0d54.webp)
...
![](/wiki/images/imgur/F0J1lzi.webp)
...
![](/wiki/images/imgur/BBz3IHF.webp)

![](/wiki/images/imgur/eHLJReo.webp)
...
### Using a Grapher
The simplest way is to connect the **condenser** used for the HP to a **Grapher** and attach it somewhere on the boss.

![](/wiki/images/imgur/JzBvFRH.webp)
...
Credits to *that guy* for this method https://principia-web.se/archive/level/4471 You can click edit to see how it's made or copy it with multi-select.

![](/wiki/images/imgur/rrBSLIE.webp)
...
![](/wiki/images/imgur/9Hnf4FN.webp)
...
## [Example Level](https://principia-web.se/archive/level/7616)
