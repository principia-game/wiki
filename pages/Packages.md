...
Initially during Principia's development it was intended for players to create their own packages and upload them to the community site using the game's Package Manager dialog. However this was seemingly scrapped around the game's release and users' package listings were quietly commented out from the community site.

## Creating packages
The package format has been documented ([Kaitai](https://github.com/Bithack/principia/blob/master/utils/kaitai/ppkg.ksy)) and there exists a tool called [package-creator](https://github.com/Bithack/principia/tree/master/utils/package-creator) which can generate a .ppkg file from a JSON file with data for the package.
