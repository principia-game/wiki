...
If you would like to suggest or discuss any changes or additions to the wiki, feel free to post in the [Wiki thread on the forums](https://principia-web.se/forum/thread?id=20) or [open an issue on GitHub](https://github.com/principia-game/wiki/issues).
