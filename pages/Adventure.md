...
## Tools
These are the most common tools that the robot has in adventure mode:
...
- [[Compressor]] - Allows you to easily store equipment to later take them out at a [[Repair Station]]. Hold down to drop the last picked up equipment, stand on a repair station and drop an item, then enter the repair station to equip it.
